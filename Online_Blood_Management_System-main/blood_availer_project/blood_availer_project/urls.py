...
from blood_availer import views
...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(template_name='blood_availer/logout.html'), name='logout'),

    path('afterlogin', views.afterlogin_view,name='afterlogin'),
    path('adminlogin', LoginView.as_view(template_name='blood_availer/adminlogin.html'),name='adminlogin'),
